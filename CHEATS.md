# GTA: SA NX - Cheat List from GTA SA Vita

### Table of Contents
+ [GTA: SA NX - Cheat List](#gta-sa-nx---cheat-list)
...
You can input PC cheats by pressing **R3** + **L3** to open the on-screen keyboard. You can input cheat codes in lowercase as well as uppercase. Note that a few cheats have been removed from the Android (Vita port) version.
...
| 27 | Black traffic | SoLongAsItsBlack | 0x4B137E45 |
...
| 64 | Spawn Dozer | ItsAllBull | 0x171BA8CC |
